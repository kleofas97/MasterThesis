Extract_liness MATLAB Python Package
...
2. Installing the Extract_liness Package

A. Change to the directory that contains the file setup.py and the subdirectory 
Extract_liness. If you do not have write permissions, copy all its contents to a 
...
3. Using the Extract_liness Package

The Extract_liness package is on your Python path. To import it into a Python script or 
session, execute:

    import Extract_liness
